...
def Make_step(y, frequency_rate):
    return _oscillator_cpp.Make_step(y, frequency_rate)
...
def grf_test_c(g):
    return _oscillator_cpp.grf_test_c(g)
grf_test_c = _oscillator_cpp.grf_test_c
